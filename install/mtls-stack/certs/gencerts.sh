...
openssl x509 -req -in certs/server-tls.generated.csr  -CA certs/rootCA.generated.crt -CAkey certs/rootCA.generated.key -set_serial 01 -CAserial certs/rootCA.generated.srl -out certs/server-tls.generated.crt -days 730 -sha256 -extfile certs/client_cert.conf
